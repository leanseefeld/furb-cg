...
public class Tela extends GLCanvas implements GLEventAdapter {
	...
	private static final TextRenderer TEXT_RENDERER = new TextRenderer(
			new Font("SansSerif", Font.BOLD, 18), true, false);
		...
		gl.glEnable(GL.GL_TEXTURE_2D);
		{
			...
			gl.glPushMatrix();
			{
				gl.glBegin(GL.GL_QUADS);
				{
					// face da frente
					gl.glNormal3f(0.0f,0.0f,-1.0f);
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-500, 0f, +500); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-500, 50f, +500); 
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(+500, 50f, +500); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(+500, 0f, +500);
					// face de traz
					gl.glNormal3f(0.0f,0.0f,1.0f);
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-500, 0f, +550f);
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-500, 50f, +550f); 
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(+500, 50f, +550f); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(+500, 0f, +550f); 
					//face de Baixo
					gl.glNormal3f(0.0f,-1.0f,0.0f);
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-500, 0f, +500); 
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-500, 0f, +550f); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(+500, 0f, +550f); 
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(+500, 0f, +500); 
					// face de cima
					gl.glNormal3f(0.0f,1.0f,0.0f);
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-500, 50f, +500); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-500, 50f, +550f); 
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(+500, 50f, +550f); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(+500, 50f, +500); 
					// face lateral esquerda
					gl.glNormal3f(-1.0f,0.0f,0.0f);
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-500, 0f, +500); 
				...
				gl.glBegin(GL.GL_QUADS);
				{
					...
					// face da traz
					gl.glNormal3f(0.0f,0.0f,1.0f);
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-550f, 0f, +500); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-550f, 50f, +500); 
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-550f, 50f, -500); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-550f, 0f, -500);
					//face de baixo
					gl.glNormal3f(0.0f,1.0f,0.0f);
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-500, 0f, +500); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-550f, 0f, -500); 
					...
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-500, 50f, +500); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-550f, 50f, -500); 
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-550f, 0f, -500);
					// face lateral direita
					gl.glNormal3f(1.0f,0.0f,0.0f);
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-500, 0f, -500); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(-500, 50f, -500); 
				...
				gl.glBegin(GL.GL_QUADS);
				{
					...
					gl.glNormal3f(0.0f,1.0f,0.0f);
					gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(+500, 50f, +500); 
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(+550f, 50f, +500); 
					gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(+550f, 50f, -500); 
					gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(+500, 50f, -500);
					// face lateral esquerda
					gl.glNormal3f(-1.0f,0.0f,0.0f);
					gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(+500, 0f, -500); 
	...
	public void reset() {
		...
		arena = new Arena();
		moto1 = new Moto("Player 1", arena.getBBox().getMenorX() + 50, 0,
				new Cor(1, 0, 0), gl);
		camera.seguirMoto(moto1);
		arena.addMoto(moto1);

		moto2 = new Moto("Player 2", arena.getBBox().getMaiorX() - 50, 0,
				new Cor(0, 1, 0), gl);
		moto2.girar(180);
		arena.addMoto(moto2);
	...
	public void setMotoJogador(Moto moto) {
		if (moto == null || moto != moto1 && moto != moto2) {
			throw new IllegalArgumentException(
					"a moto informada não faz parte do jogo");
		}
	 ...
	 * 
	 * @return {@code true} se passou para o modo de perspectiva; {@code false}
	 *         se passou para o modo ortogonal
	 */
