...
/* This class calculates the 'edge' coordinates for the model along its three dimensions. The edge
 * coords are used to calculate the model's: width, height, depth its largest dimension (width,
 * height, or depth) (x, y, z) center point */
