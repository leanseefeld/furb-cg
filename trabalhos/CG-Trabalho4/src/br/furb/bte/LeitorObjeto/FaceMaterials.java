...
/* FaceMaterials stores the face indicies where a material is first used. At render time, this
 * information is utilized to change the rendering material when a given face needs to be drawn. */
