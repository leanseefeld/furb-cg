...
/* A Material object holds colour and texture information for a named material. The Material object
 * also manages the rendering using its colours (see setMaterialColors()). The rendering using the
