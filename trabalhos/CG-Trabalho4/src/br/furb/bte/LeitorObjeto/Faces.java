...
// -------------------- inner Class ---------------------------
/* Faces stores the information for each face of a model. A face is represented by three arrays of
 * indicies for the vertices, normals, and tex coords used in that face. facesVertIdxs,
 * facesTexIdxs, and facesNormIdxs are ArrayLists of those arrays; one entry for each face.
 * renderFace() is supplied with a face index, looks up the associated vertices, normals, and tex
 * coords indicies arrays, and uses those arrays to access the actual vertices, normals, and tex
 * coords data for rendering the face. */
